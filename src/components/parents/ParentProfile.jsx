...
const ParentProfile = () => {
  // ✅ Matches ACTUAL API shape: top-level + nested user object
  ...
  // --- Password states — Change Password + Forgot Password ---
  ...
  const fetchProfile = useCallback(async () => {
    try {
      setLoading(true);
      setError("");
      const { data } = await api.get("accounts/parent-profile/");
      console.log("Raw Parent Profile data:", data);
      const singleProfile = Array.isArray(data) ? data[0] : data;
      setProfile(singleProfile || {
        id: null, occupation:"", address:"", user:{}
      });
    } catch (err) {
  ...
  const updateProfile = async (e) => {
    ...
    try {
      ...
      console.log("Updating parent profile:", profile);
        ...
        {!editMode ? (
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <p className="font-medium text-gray-800 capitalize">{profile.user?.role || "Parent"}</p>
              </div>
            </div>
          ...
          <form onSubmit={updateProfile} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="form-lable">Occupation</label>
                <input type="text" className="milk-input" 
                  name="occupation"
              ...
              <div className="md:col-span-2">
                ...
                <input type="text" className="milk-input" 
                  name="role"
                  value={profile.user?.role || "Parent"} readOnly />
              </div>
            </div>
